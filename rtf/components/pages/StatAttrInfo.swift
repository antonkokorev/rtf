...
struct StatAttrInfo: View {
	...
	@ObservedObject var attrData: StatisticsState = ObservableState(store: mainStore).state.statisticsSubState
...
struct StatAttrInfo_Previews: PreviewProvider {
	static var previews: some View {
		StatAttrInfo(id:"0", title:"Какой-то там очень длинный в несколько строк атрибут")
	}
}
